...
<div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: center;">
    ...
    <!-- WhatsApp -->
    <a href="https://api.whatsapp.com/send?1=pt_pt&phone=351924244819"
       style="width:180px; height:54px; background:#25D366; color:white;
    ...
    <a href="https://www.youtube.com/@machines_net"
       style="width:180px; height:54px; background:#FF0000; color:white;
        ...
        <!-- GitHub -->
    <a href="https://github.com/EdgarMata"
    style="width:180px; height:54px; background:#181717; color:white;
            display:flex; align-items:center; justify-content:center;
            gap:8px; text-decoration:none; border-radius:8px; font-weight:600;">
